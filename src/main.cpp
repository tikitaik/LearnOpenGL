...
int main(int argc, char* argv[])
{
    ...
    glm::mat4 asteroidTranslations[AMOUNT];
    srand(glfwGetTime());
    float radius = 150.0f;
    float offset = 25.0f;
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(glm::mat4) * AMOUNT, &asteroidTranslations[0], GL_STATIC_DRAW);
